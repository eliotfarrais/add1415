...
BEGIN{
		...
		FS=";"; 
		# Indicamos cuál es el carácter delimitador de campos
		dominio="OU=FP,DC=eliot,DC=com"
...
}
{
		...
		print "dsadd user -upn "usuario"@eliot.com \"CN="nombreordenado","unidad"\" -samid "usuario" -disabled no -pwd $M"clave"a# -mustchpwd yes -memberof \""grupo"\" -fn \""nombre"\" -ln \""apellido1" "apellido2"\" -display \""nombrecompleto"\" -q" > fichero
